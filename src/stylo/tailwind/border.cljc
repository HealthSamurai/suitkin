   ...
   [[:& (->> props
             (reduce (fn [acc x]
                       (if (int? x)
                         ...
                         (assoc acc :border-top-color (with-alpha (colors x) :--border-opacity) :--border-opacity 1)))
   ...
   [[:& (->> props
             (reduce (fn [acc x]
                       (if (int? x)
                         ...
                         (assoc acc :border-bottom-color (with-alpha (colors x) :--border-opacity) :--border-opacity 1)))
   ...
   [[:& (->> props
             (reduce (fn [acc x]
                       (if (int? x)
                         ...
                         (assoc acc :border-left-color (with-alpha (colors x) :--border-opacity) :--border-opacity 1)))
...
(defmethod rule :border-r
  ...
  ([_ & props]
   [[:& (->> props
             (reduce (fn [acc x]
                       (if (int? x)
                         (assoc acc :border-rigth-width (as-unit x :px))
                         (assoc acc :border-right-color (with-alpha (colors x) :--border-opacity) :--border-opacity 1)))
